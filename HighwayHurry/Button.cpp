...
Button::Button(const sf::Sprite& sprite, const Vector3 position, const sf::Color normalColor,
    const sf::Color hoveringColor, const sf::Font& font, const std::string textOnButton) : Entity{ sprite }, position{ position },
